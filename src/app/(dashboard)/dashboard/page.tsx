                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="text-xs font-semibold truncate flex items-center gap-1.5">
                          {member.name}
                          {appVersions[member.userId] === 'mac' ? <span className="text-[9px] font-bold px-1 py-0.5 rounded bg-yellow-100 text-yellow-700">🍎 MacBook</span> : appVersions[member.userId] === '1.1.1'
